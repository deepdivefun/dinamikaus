...
<div class="page-header d-print-none">
    <div class="container-xl">
        ...
        <button type="button" class="btn btn-outline-primary rounded-5" data-bs-toggle="modal" data-bs-target="#addShippingLogo">
            Create Shipping Logo
        </button>

        <!-- Add Modal -->
        <div class="modal fade" id="addShippingLogo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title" id="staticBackdropLabel">Add Shipping Logo</h1>
                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label" for="ShippingName">Shipping Name</label>
                                <input type="text" class="form-control" name="ShippingName" id="ShippingName" required>
                            </div>

                            <div class="form-group mb-3">
                                <label class="form-label" for="ShippingPhoto">Shipping Photo</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-outline-primary rounded-5" onclick="createShippingLogo();">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <!-- Edit Modal -->
        <div class="modal fade" id="editShippingLogo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title" id="staticBackdropLabel">Edit Shipping Logo</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label" for="EditShippingName">Shipping Name</label>
                                <input type="text" class="form-control" name="EditShippingName" id="EditShippingName" required>
                            </div>

                            <div class="form-group mb-3">
                                <label class="form-label" for="EditShippingPhoto">Shipping Photo</label>
                                <input type="file" class="form-control" name="EditShippingPhoto" id="EditShippingPhoto" accept="image/png, image/jpeg, image/jpg, image/webp">
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control" name="EditShippingID" id="EditShippingID" readonly required>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline-danger rounded-5" data-bs-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-outline-primary rounded-5" onclick="updateShippingLogo();">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <form method="POST">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        <div class="form-group mb-3">
                                            <label class="form-label" for="FilterShippingName">Shipping Name</label>
                                            <input type="text" class="form-control" name="FilterShippingName" id="FilterShippingName">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-footer mb-3">
                                <button type="button" class="btn btn-outline-info w-100 rounded-5" onclick="showButtonShippingLogoData();">Show Data</button>
                            </div>
                        </form>
...
echo '<script src="11000.ShippingLogo.js"></script>';
