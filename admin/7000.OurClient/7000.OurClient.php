                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        <div class="form-group mb-3">
                                            <label class="form-label" for="FilterOurClientName">Our Client Name</label>
                                            <input type="text" class="form-control" name="FilterOurClientName" id="FilterOurClientName">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-footer mb-3">
                                <button type="button" class="btn btn-outline-info w-100 rounded-5" onclick="showButtonOurClientData();">Show Data</button>
                            </div>
                        </form>
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-nowrap datatable" id="dataTable">
                                <thead>
                                    <tr>
                                        <th>Our Client Name</th>
                                        <th>Our Client Photo</th>
                                        <th>Status</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
...
echo '<script src="7000.OurClient.js"></script>';
