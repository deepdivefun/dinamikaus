            ...
            try {
                ...
                if ($stmt->affected_rows > 0) {
                    try {
                        ...
                        // $mail->Host         = 'mail.zaverynautama.com';                         // Set the SMTP server to send through
                        $mail->SMTPAuth     = true;                                     // Enable SMTP authentication
                        $mail->Username     = 'noreply@dinamikaus.com';            // SMTP username
                        // $mail->Username     = 'noreplay@zaverynautama.com';            // SMTP username
                        $mail->Password     = 'skpEn@FE(;8B';                       // SMTP password
                        // $mail->Password     = 'zaverynautama';                       // SMTP password
                        $mail->SMTPSecure   = PHPMailer::ENCRYPTION_SMTPS;              // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
                        $mail->Port         = 465;                                      // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

                        //Recipients
                        $mail->setFrom('noreply@dinamikaus.com', 'noreply');
                        // $mail->setFrom('noreplay@zaverynautama.com', 'noreplay');
                        ...
                        <br>
                        <button class="btn btn-primary rounded-5"><a href="http://localhost/dinamikaus/utilities/10000.ForgotPassword/10100.ForgotPasswordReset.php?Token=$ResetTokenHash" class="btn btn-primary">http://localhost/dinamikaus/utilities/10000.ForgotPassword/10100.ForgotPasswordReset.php?Token=$ResetTokenHash</a></button>
                        <br>
                        <br>
