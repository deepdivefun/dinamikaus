         ...
         <div class=''>
            <div class='grid justify-items-center' >
                ...
                <div class='' >
                    ...
                    <p class='text-xs mt-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                        Animi ipsam vero obcaecati. Sit, harum.</p>
                </div>
            </div>
        </div>
         <div>
            <div class='flex   gap-6' >
                <!-- <span>Icon</span> -->
            <div class=' gap-6 ' >
                <p class='font-semibold text-xl' >Informasi</p>
               <ul>
                    <li>informasi 1</li>
                    <li>informasi 2</li>
                    <li>informasi 3</li>
